...
export const ADDICTION_TYPES: AddictionTypeConfig[] = [
  ...
  },
  {
    ...
    icon: "beer",
    labelKey: "beer",
    counterLabelKey: "timeSinceLastBeer",
    unitLabelKey: "beersAvoided",
    defaultPerDay: 3,
    caloriesPerUnit: 150,
    showPerDay: true,
    showPatchTracker: false,
  ...
  },
  {
    ...
    icon: "wine",
    labelKey: "wine",
    counterLabelKey: "timeSinceLastWine",
    unitLabelKey: "winesAvoided",
    defaultPerDay: 2,
    caloriesPerUnit: 120,
    showPerDay: true,
    showPatchTracker: false,
  ...
  },
  {
    ...
    icon: "spirits",
    labelKey: "spirits",
    counterLabelKey: "timeSinceLastSpirits",
    unitLabelKey: "shotsAvoided",
    defaultPerDay: 3,
    caloriesPerUnit: 65,
    showPerDay: true,
    showPatchTracker: false,
  ...
  },
  {
    ...
    icon: "cocktails",
    labelKey: "cocktails",
    counterLabelKey: "timeSinceLastCocktail",
    unitLabelKey: "cocktailsAvoided",
    defaultPerDay: 2,
    caloriesPerUnit: 200,
    showPerDay: true,
    showPatchTracker: false,
