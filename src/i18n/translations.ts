...
export const translations = {
  en: {
    ...
    // Survey
    surveyMotivationTitle: "Why do you want to quit?",
    surveyMotivationSubtitle: "Understanding your motivation helps you stay on track.",
    surveyHealthReason: "Health",
    surveyMoneyReason: "Save money",
    surveyFamilyReason: "Family",
    surveySelfReason: "Self-improvement",
    surveyReadinessTitle: "How ready are you?",
    surveyReadinessSubtitle: "Rate your readiness to change on a scale of 1–10.",
    surveyNotReady: "Not ready",
    surveyVeryReady: "Very ready",
    surveyPastAttemptsTitle: "Past quit attempts",
    surveyPastAttemptsSubtitle: "Have you tried quitting before?",
    surveyNever: "Never tried",
    surveyOnce: "Once",
    surveyFewTimes: "A few times",
    surveyManyTimes: "Many times",
  ...
  cs: {
    ...
    // Survey
    surveyMotivationTitle: "Proč chcete přestat?",
    surveyMotivationSubtitle: "Pochopení motivace vám pomůže vytrvat.",
    surveyHealthReason: "Zdraví",
    surveyMoneyReason: "Úspora peněz",
    surveyFamilyReason: "Rodina",
    surveySelfReason: "Sebezlepšení",
    surveyReadinessTitle: "Jak jste připraveni?",
    surveyReadinessSubtitle: "Ohodnoťte svou připravenost na změnu na škále 1–10.",
    surveyNotReady: "Nepřipravený/á",
    surveyVeryReady: "Velmi připravený/á",
    surveyPastAttemptsTitle: "Předchozí pokusy",
    surveyPastAttemptsSubtitle: "Zkoušeli jste už přestat?",
    surveyNever: "Nikdy",
    surveyOnce: "Jednou",
    surveyFewTimes: "Několikrát",
    surveyManyTimes: "Mnohokrát",
