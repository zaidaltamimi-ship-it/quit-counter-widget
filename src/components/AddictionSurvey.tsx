...
import { ArrowLeft, ArrowRight, Sparkles, Ban, TrendingDown, Dumbbell, Brain, Bandaid, Droplets, SprayCan, Frown, Beer, Moon, RefreshCw, Heart, PartyPopper } from "lucide-react";
